...
def CapsNetBasic(input_shape, n_class=2):
    ...
    out_seg = layers.Conv2D(filters=1, kernel_size=1, strides=1, padding='same', activation='sigmoid', name='out_seg')(out_seg_1)
    ...
    def shared_decoder(mask_layer):
        ...
        recon_1 = layers.Conv2D(filters=512, kernel_size=1, padding='same', kernel_initializer='he_normal',
    ...
    # layer_outputs = [layer.output for layer in models.layers]  # Extracts the outputs
    # activation_model = models.Model(inputs=x,
